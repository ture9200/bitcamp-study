...
abstract class A2 {
  ...
  //
  // 추상 메서드의 용도
  // - 서브 클래스 마다 구현이 다를 수 있는 경우에 사용한다. 추상메서드는 반드시 정의해야한다. 
...
class A2Sub extends A2 { // 상속받음 
  @Override
  public void m1() { //m1을 오버라이딩, 구현했다 
    // 서브 클래스에서 추상 메서드를 구현해야 한다.
  }
}

public abstract class Exam02 extends A2 { // 구현하지 않았다. 그래서 abstract를 써줘야한다. 아니면 구현해줘야한다. 
