...
public class MyList {
  ...
  int size; // 현재 사이즈 , add할 곳을 가리킴, 들어갈 자리 가리킨다. 
  ...
  public Object remove(int index) {
    ...
    //사이즈가 3이면 size-1 이니 2까지 돈다는 것 , 3이었다가 가운데걸 하나 지우면서 사이즈가 2로 바뀌어서 
    // 사이즈가 먼저 줄였으니 2 ,항상 배열의 사이즈는 다음에 들어갈 장소를 가리키니까 
    // 앞으로 땡겨진거니까 다음자리를 null로 함으로써 줄이는것 
    // 항상 관리를 해줘야한다.  앞으로 땡겨지면서 주소를 받는다. 
    //
