...
public class Exam0112 {
  public static void main(String[] args) {
    ...
    // - 클래스 이름: 대문자 , 변수명과 메서드 이름: 소문자로 시작 
    // - 클래스는 보통 명사형으로 짓는다. 
    // - 반면 메서드는 동사형으로 짓는다. 전치사구 형태도 있다. 예)toString 
    //
    ...
    //   => s가 가리키는 인스턴스의 각 필드 값을 설정한다. 필드= 변수 
    //   => s 인스턴스의 필드 값을 설정한다.
    //   => s 객체의 필드 값을 설정한다.
    //
...
//   레퍼런스명.항목명 = 값;
//   예) Score s = new Score(); 
//      Score s; // NullpointerException 에러 뜸!! 레퍼런스에 주소가 없음 
//       s.name = "홍길동"; //레퍼런스명.항목명 = 값;
//
