...
// 5)  계산기 기능 확장 방법 3 - 포함관계를 통한 기능 확장 
//   - 곱하기 계산 기능 추가
//   - 기존의 Calculator 객체를 포함한 후 새 기능을 추가하기 

public class CalculatorTest {
  public static void main(String[] args) {
    Calculator2 c = new Calculator2(); //Calculator 객체를 내장하고 있다. 
    // Calculator2의 Calculator 의 생명주기가 짧다. 
...
//       C <-- D 
//  => 여기서 D는 B 의 기능이 필요없음에도 어쩔 수 없이 상속 받아야한다. 
//     왜? C가 B를 상속받기 때문이다. 
//     이것이 코드가 경직되었다는 뜻이다. 
