...
public class CalculatorTest {
  public static void main(String[] args) {
    ...
    c.plus(100);
    //plus라는 메서드는 calculator 에 있는 메서드를 호출하면서 
    //메서드의 내장변수 this 들어갈 값을 앞부분에 전달한다. 
    c.minus(200);
...
// 2) 기존 코드에 계속 코드를 추가하다보면 코드가 커지고 복잡해져서 유지보수에 어려워진다. 
// 3) 새로 추가한 기능이나 변경한 기능이 다른 프로젝트에서 나중에 필요없을 때 기존 코드에서 제거하기 힘들다. 
