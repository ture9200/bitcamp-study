...
public class Receiver {
  ...
  public static void main(String[] args) throws Exception {
    ...
    //      - 1~ 1023 사이의 포토 번호는 특정 서버가 사용하기 위해 미리 예약된 번호다. 
    ...
    ServerSocket serverSocket = new ServerSocket(8888); // 소켓 객체 생성 
    ...
    PrintStream out = new PrintStream(socket.getOutputStream()); // 데이터를 출력할 때 printStream으로 읽는다. 
    Scanner in = new Scanner(socket.getInputStream()); // 데이터를 읽을 때 Scanner로 읽는다. 
