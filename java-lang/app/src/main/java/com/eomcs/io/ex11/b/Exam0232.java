...
public class Exam0232 {
  ...
  // 복제 기능을 활성화 시키기 위해서 Cloneable 인터페이스를 구현했다. 
  ...
  public static void main(String[] args) throws Exception {
    ...
    System.out.println(obj instanceof Cloneable); // 복제가 허락된 객체다. 

    Score copy = obj.clone(); // copy는 obj를 복제한 객체라서 다른 객체다. 객체주소도 다르다. 

    System.out.println(obj == copy); // OK! Score3 클래스는 복제를 허락했기 때문이다. 
    System.out.println(obj.name); // 복제했기때문에 이름값이 같이 나온다. 
